...
const BLOCK_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/gravyswap/blocks'
const STREAMING_FAST_ENDPOINT = 'https://bsc.streamingfast.io/subgraphs/name/gravyswap/exchange-v2'
