...
import { ButtonMenu, ButtonMenuItem, LinkExternal, Flex, Svg, Image, Button } from '@gravyswap/uikit'
      ...
      >
        <BubbleWrapper>
          <Button
            ...
            as="a"
            external
            href="https://gravyswap-1.gitbook.io/gravyswap-1/contact-us/email"
            variant="primary"
          >
            {t('Support')}
          </Button>
        </BubbleWrapper>
        <Image src="/images/help.png" alt="Get some help" width={133} height={90} />
      </Flex>
    </Wrapper>
  )
}
