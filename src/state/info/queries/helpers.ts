...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, GravyDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | GravyDayData): ChartEntry => ({
