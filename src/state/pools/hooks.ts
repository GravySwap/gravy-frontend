...
export const useGravyVault = () => {
  const {
    ...
    userData: {
      ...
      gravyyAtLastUserAction:gravyvyAtLastUserActionAsString,
      lastDepositedTime,
      lastUserActionTime,
    },
  ...
  const gravyyAtLastUserAction = useMemo(() => {
    return new BigNumber(gravyyAtLastUserActionAsString)
  }, [gravyyAtLastUserActionAsString])
