...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Gravy Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Gravy Bunny NFTs at the snapshot may also purchase one additional Gravy Squad NFT in the presale for each Gravy Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of GRAVY spent on Gravy Squad NFTs will be burned as part of our weekly GRAVY burn.')],
  },
  {
