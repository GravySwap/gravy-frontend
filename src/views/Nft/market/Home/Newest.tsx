...
import { Heading, Flex, Button, Grid, ChevronRightIcon } from '@gravyswap/uikit'
  ...
  return (
    <div>
      ...
      {nfts ? (
        ...
        >
          {nfts.map((nft) => {
            const isPBCollection = nft.collectionAddress.toLowerCase() === gravyBunniesAddress.toLowerCase()
