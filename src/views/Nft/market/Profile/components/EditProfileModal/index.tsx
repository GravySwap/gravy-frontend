...
import { InjectedModalProps, Modal } from '@gravyswap/uikit'
...
import ApproveGravyView from './ApproveGravyView'
  ...
  return (
    <Modal title={viewTitle(t, currentView)} onBack={handleBack} onDismiss={onDismiss} hideCloseButton={!isStartView}>
      <div style={{ maxWidth: '400px' }}>
        ...
        {currentView === Views.APPROVE && <ApproveGravyView goToChange={goToChange} onDismiss={onDismiss} />}
      </div>
    </Modal>
  )
}
