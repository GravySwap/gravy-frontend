...
import { Image, Flex, Text, Td, IconButton, Link, OpenNewIcon, useMatchBreakpoints, useModal } from '@gravyswap/uikit'
...
const ActivityRow: React.FC<ActivityRowProps> = ({
  ...
  const isPBCollection = nft ? nft.collectionAddress.toLowerCase() === gravyBunniesAddress.toLowerCase() : false
  const tokenId =
    nft && isPBCollection
