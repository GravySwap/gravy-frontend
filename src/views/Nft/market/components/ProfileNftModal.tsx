...
import { InjectedModalProps, Modal, Flex, Text, Button, useModal, Link, Grid, LinkExternal } from '@gravyswap/uikit'
...
const ProfileNftModal: React.FC<ProfileNftModalProps> = ({ nft, onDismiss }) => {
  ...
  const itemPageUrlId = nft.collectionAddress === gravynniesAddress ? nft.attributes[0].value : nft.tokenId
