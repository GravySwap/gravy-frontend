...
import { SaleStatusEnum, UserStatusEnum } from 'views/GravySquad/types'
...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, gravyBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold GRAVY'),
      bodyText: [t('Each NFT costs GRAVY to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://gravyswap.com/swap?outputCurrency=0x5eA26D0d36EAF02d63a3023521A7924e19c34454"
            target="_blank"
            width="100%"
          >
            {t('Buy GRAVY')}
