...
import { Modal, Button, Flex, AutoRenewIcon, Heading, Text, Image } from '@gravyswap/uikit'
...
const ClaimModal: React.FC<CompetitionProps> = ({ onDismiss, onClaimSuccess, userTradingInformation }) => {
  ...
  const { gravyReward, lazioReward, portoReward, santosReward } = useCompetitionRewards({
    userGravyRewards,
    userLazioRewards,
    userPortoRewards,
    userSantosRewards,
