import { BlockIcon, CheckmarkCircleIcon, Flex, Image, Skeleton, Text } from '@gravyswap/uikit'
...
const UserPrizeGrid: React.FC<{ userTradingInformation?: UserTradingInformationProps }> = ({
  ...
  const { gravyReward, lazioReward, portoReward, santosReward, dollarValueOfTokensReward } = useCompetitionRewards({
    userGravyRewards,
    userLazioRewards,
    userPortoRewards,
    userSantosRewards,
        ...
        <tr>
          <BoldTd>
            <Flex flexDirection="column">
              <Text bold>{gravyReward.toFixed(2)} GRAVY</Text>
