...
import { ADMINS, PANGRAVY_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'cake', params: { symbol: 'GRAVY', address: tokens.cake.address, decimals: 18 } }],
  }
}
